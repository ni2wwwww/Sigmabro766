...
function generateFakeAddress($countryCode = 'us') {
    ...
    $proxy_auth = base64_encode('76ae20ff1afab170727e:53d778d7bde5d0d0');
    ...
    // Fetch data from API using the context
...
function output($method, $data) {
    ...
    curl_setopt($out, CURLOPT_PROXY, 'brd.superproxy.io:33335');
    curl_setopt($out, CURLOPT_PROXYUSERPWD, 'brd-customer-hl_76d20745-zone-residential_proxy1:6r8r4xnqdj8f');
    curl_setopt($out, CURLOPT_PROXYTYPE, CURLPROXY_HTTP);
...
if ($site1 === false) {
    ...
    curl_setopt($ch, CURLOPT_PROXYUSERPWD, 'brd-customer-hl_76d20745-zone-residential_proxy1:6r8r4xnqdj8f');
